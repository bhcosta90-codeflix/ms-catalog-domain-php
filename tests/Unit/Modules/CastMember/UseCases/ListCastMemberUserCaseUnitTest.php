...
use Costa\Core\Modules\CastMember\UseCases\ListCastMemberUseCase as UseCase;
use Costa\Core\Utils\Contracts\PaginationInterface;
use Costa\Core\Modules\CastMember\UseCases\DTO\List\Input;
use Costa\Core\Modules\CastMember\UseCases\DTO\List\Output;
use Mockery;
use PHPUnit\Framework\TestCase;
use stdClass;

class ListCastMemberUserCaseUnitTest extends TestCase
{
    public function testListCastMemberUseCaseEmpty()
    {
    ...
    public function testListCastMemberUseCase()
    {
